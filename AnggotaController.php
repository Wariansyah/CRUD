...
class AnggotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $simpananData = [
            ...
            'tgl_buka' => $anggota->created_at, // Waktu anggota dibuat
            'tgl_tutup' => null, // Tanggal tutup awalnya null
            'nominal' => null, // Awalnya null
            'keterangan' => $anggota->nama, // Menggunakan nama anggota sebagai keterangan
        ];
